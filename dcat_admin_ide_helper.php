...
namespace Dcat\Admin {
     ...
     * @property Grid\Column|Collection crossed_price
     ...
     * @method Grid\Column|Collection crossed_price(string $label = null)
     ...
     * @property Show\Field|Collection crossed_price
     ...
     * @method Show\Field|Collection crossed_price(string $label = null)
